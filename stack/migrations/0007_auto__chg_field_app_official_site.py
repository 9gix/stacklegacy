...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'App.official_site'
        db.alter_column(u'stack_app', 'official_site', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'App.official_site'
        db.alter_column(u'stack_app', 'official_site', self.gf('django.db.models.fields.URLField')(default='http://stacklegacy.com', max_length=200))
