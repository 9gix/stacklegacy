...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'App.logo'
        db.alter_column(u'stack_app', 'logo', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'App.logo'
        db.alter_column(u'stack_app', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
