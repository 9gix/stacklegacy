...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'App', fields ['slug']
        db.create_unique(u'stack_app', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'App', fields ['slug']
        db.delete_unique(u'stack_app', ['slug'])
